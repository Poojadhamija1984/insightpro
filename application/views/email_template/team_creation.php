	...
	<body>
		<table style="border-collapse: collapse;width: 75%;max-width:600px;margin: 40px auto;font-weight:400;font-family: Montserrat, sans-serif;border: 1px solid #dcdcdc;">
            <thead>
                ...
                <tr>
                    <th style="padding:20px 30px 6px;text-align: center;text-transform: capitalize;font-size:20px;font-weight:800;color: #2E7D32;">Dear <?php echo $name;?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="padding:20px 30px 0px;text-align: center;line-height: 1.6;font-size: 13px;font-weight:500;color: #565656;">Your login Credentials</td>
                </tr>
                <tr>
                    <td style="padding:0px 30px;text-align: center;line-height: 1.6;font-size: 13px;font-weight:500;color: #565656;"><span style="font-weight:bold">User ID:</span> <?php echo $user_email;?></td>
                </tr>
                <tr>
                    <td style="padding:0px 30px 15px;text-align: center;line-height: 1.6;font-size: 13px;font-weight:500;color: #565656;"><span style="font-weight:bold">Password:</span> <?php echo $this->config->item('default_password');?></td>
                </tr>
                <tr>
                    <td style="padding:20px 30px 15px;text-align: center;line-height: 1.6;font-size: 13px;font-weight:500;color: #565656;">Please access the below account URL and login with above credentials to access the InsightsPro</td>
                </tr>
                <tr>
                    <td style="padding:0 30px 20px;text-align: center;font-size: 14px;text-transform: capitalize;color:rgb(255, 255, 255);font-weight:600;"><a href="<?php echo site_url('login');?>" style="background-color:#26a4d3;;color:rgb(255, 255, 255);display:inline-block;vertical-align: middle;text-decoration: none;padding:10px 24px;border-radius: 30px;text-transform:uppercase;letter-spacing: 0.5px;font-size: 12px;">Account URL</a></td>
                </tr>
                <tr>
