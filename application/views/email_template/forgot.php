    ...
    <body>
        <table style="border-collapse: collapse;width: 75%;max-width:600px;margin: 40px auto;font-weight:400;font-family: Montserrat, sans-serif;border: 1px solid #dcdcdc;">
            <thead>
                ...
                <tr>
                    <th style="padding:20px 30px 6px;text-align: center;text-transform: capitalize;font-size:20px;font-weight:800;color: #2E7D32;">Hi, <?php echo $name;?></th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding:20px 30px 15px;text-align: center;line-height: 1.6;font-size: 13px;font-weight:500;color: #565656;">
                    You recently requested to reset your password for your InsightsPro account.Click the button below to reset it.</td>
                </tr>
                <tr>
                    <td style="padding:0 30px 20px;text-align: center;font-size: 14px;text-transform: capitalize;color:rgb(255, 255, 255);font-weight:600;"><a href="<?php echo site_url();?>/reset-password/<?php echo $email;?>" target="_blank" style="background-color:#26a4d3;;color:rgb(255, 255, 255);display:inline-block;vertical-align: middle;text-decoration: none;padding:10px 24px;border-radius: 30px;text-transform:uppercase;letter-spacing: 0.5px;font-size: 12px;">Reset Password</a></td>
                </tr>
                <tr>
