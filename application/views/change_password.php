...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Change Password :: InsightsPRO</title>
    ...
    <body class="body_bg custom-scrollbar">
        <?php
        $attributes = array('id' => 'reset_form','class' => 'change form-card user-forgot z-depth-4','method'=>'POST');
        ...
        ?>
            ...
            <div class="form-card-footer">
                <button class="btn waves-effect waves-light border-round btn-gradient">Change Password</button>
                <a class="small_text" href="<?php echo site_url().'/logout'; ?>">Logout</a>
            </div>
        <?php echo form_close();?>
