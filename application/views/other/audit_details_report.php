                ...
                <div class="main-contents">
                        ...
                        <div class="breadcrumb-inner d-flex align-items-center justify-content-between">
                            <div class="breadcrumb-left">
                                ...
                                <ul class="breadcrumb-list">
                                    <li class="breadcrumb-item"><span>Opportunity</span></li>
                                </ul>
                            </div>
                   ...
                   <?php $attributes = array("id" => "form col",'class'=>'formview');
                    ...
                    <div class="table-section mt-24">
                        <div class="card">
                            <div class="card-content">
                                <table class="stripe hover data_table" id="escalation_data" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Audit ID</th>
                                            <th>Auditor</th>
                                    ...
                                    <tbody >
                                        ...
                                        foreach ($content as $key => $value) {
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>$value->auditor_comment</td>
                                                    <td>$value->total_failed</td>
