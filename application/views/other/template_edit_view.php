            ...
            <main>
                ...
                <div class="main-contents">
                        ...
                        <div class="breadcrumb-inner d-flex align-items-center justify-content-between">
                            <div class="breadcrumb-left">
                                ...
                                <ul class="breadcrumb-list">
                                    <li class="breadcrumb-item"><span>Edit Form</span></li>
                                </ul>
                            </div>
                            <div class="breadcrumb-right">
							<?php if(!empty($welcomesetup_other_form)){ ?>
                                <a class="back_btn2 mr-12" href="<?= site_url();?>/other-template-list/welcome_other_form">Back</a>
					...
					<?php
						if(!empty($welcomesetup_other_form))
						{
							echo '<input type="hidden" id="welcomesetup_other_form" name="welcomesetup_other_form" value="'.$welcomesetup_other_form.'">';
							//print_r($welcomesetup_other_form) ;
						}
					?>
                    <!-- PAGE ERROR END -->
                    ...
                    <div class="form_accordion mt-24">
                        ...
                        <form class="form_creation">
							...
							<?php if($copy=='copy') { ?>
								<input type="hidden" id="versionid" value="<?php echo $copy; ?>">
							...
							<div class="form_intro row">
								<div class="col m6">
									...
									<input type="text" name="tmp_name" id="tmp_name" value="<?php echo (!empty($tmp_name)?$tmp_name:'');?>" placeholder="Enter Form Name" required>
			...
			$(document).ready(function(){
				...
				$(document).on("click", ".btn_form_final_submit ", function(){ 
					if($('#tmp_name').val() === ""){
						...
						//alert($('#tat_time').val());return false;
						var final_data = [], each_question = [];
						if (typeof ($('#welcomesetup_other_form').val()) != "undefined") {
							//alert($('#welcomesetup_other_form').val());
							final_data.push({
								welcomesetup_other_form : $('#welcomesetup_other_form').val()
							});
						}
						final_data.push({
						...
						// return false;
						//console.log(final_data);
						var ver = $('#versionid').val();
						console.log(ver);
						if(ver=='copy')
						{
							var ajaxRes = postAjax('<?php echo site_url();?>/template-copy',{'template_data':final_data,'copy':ver});
						}else{
						...
						if(ajaxRes == 'success')
						{
							...
							$('#log_msg').html('Form save successfully  ....'); 	
						}else if(ajaxRes == 'welcomesetup_other_form_success'){
							//alert('welcomesetup_other_form_success');
							$('.page_error').addClass('success');
							$('.page_error').removeClass('failure');
							...
							$('#log_msg').html('Form is not save try again ....'); 	
