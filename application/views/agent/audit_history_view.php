            ...
            <main>
                ...
                <div class="main-contents">
                    ...
                    <div class="breadcrumb-section mb-12">
                        <div class="breadcrumb-inner d-flex align-items-center justify-content-between">
                            <div class="breadcrumb-left">
                                <h3 class="page-title">Audit History</h3>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row mb-0">
                                    ...
                                    <div class="input-field col s12 m4 xl3">
                                        <input id="toDate" type="text" class="datepicker" value="<?php echo date('Y-m-d',strtotime('+1 day', strtotime(date('Y-m-d'))));?>">
                    ...
                    <div class="table-section mt-24">
                        <div class="card">
                            <div class="card-content">
                                <h4 class="card-title">Audit History Summary</h4>
                                <table class="data_table  stripe hover" id="audit_data" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Unique ID</th>
                                            <th>Lob</th>
...
$(document).ready(function() {
    ...
    var reports_response  = postAjax('<?php echo site_url();?>/audit-data',{'fromDate':$('#fromDate').val(),'toDate':$('#toDate').val(),'lob':$('#lob').val()});
        //console.log(reports_response);
        $('#audit_data').dataTable({
            "bDestroy": true,
            responsive: true,
            fixedHeader: true,
            scrollX : true,
...
///oncliclik submit button 
    $('#submit').click(function(e){
        e.preventDefault();
        var reports_response  = postAjax_With_Loder('<?php echo site_url();?>/audit-data',{'fromDate':$('#fromDate').val(),'toDate':$('#toDate').val(),'lob':$('#lob').val()});
       // console.log(reports_response);
        $('#audit_data').dataTable({
            "bDestroy": true,
            responsive: true,
