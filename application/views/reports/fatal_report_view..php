...
<?php $this->load->view('common/head_view') ?>
    <body>
                        ...
                        <div class="breadcrumb-inner d-flex align-items-center justify-content-between">
                            <div class="breadcrumb-left">
                                ...
                                <ul class="breadcrumb-list">
                                   <li class="breadcrumb-item"><span>Fatal</span></li>
                                </ul>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <?php  // $attributes = array('class' => '','method'=>'POST');
                                    // echo form_open(site_url().'/Fatal-Report-List', $attributes);?>
        ...
        <script type="text/javascript">
            $(function(){
                $('#submit').click(function(e){
                    ...
                    if((audit_from == null))
                    {
                        ...
                        var reports_response  = postAjax('<?php echo site_url();?>/Fatal-Report-List',{'audit_from':audit_from,'audit_to':audit_to,'date_column':date_column,'lob':lob,'campaign':campaign,'vendor':vendor,'location':location,'agents':agents});
                    ...
                    //     }
                        ...
                        $('.data_table').dataTable({
                            ...
                            },
                            {
                                ...
                                {
                                    return '<a href="javascript:void(0)" onclick="data_list(`'+audit_from+'`,`'+audit_to+'`,`'+date_column+'`,`'+campaign+'`,`'+vendor+'`,`'+location+'`,`'+data.lob+'`,`'+data.agent_name+'`,`'+data.agent_id+'`,`'+agents+'`,`'+data.form_version+'`,`check_fatal_only`)">'+data.totalfatel_count+'</a>';
                                }
                            }]
                        });  
                    }
            ...
            function data_list(audit_from,audit_to,date_column,campaign,vendor,location,lob,agent_name,agent_id,agents,form_version,data_list_type = '')
            {
                //alert(form_version);
               // alert(audit_from+'\n'+audit_to+'\n'+date_column+'\n'+campaign+'\n'+vendor+'\n'+location+'\n'+lob+'\n'+agent_name+'\n'+agent_id);
               $('.data_list_div').show();
                var reports_response  = postAjax('<?php echo site_url();?>/Fatal-Report-Audit-List',{'audit_from':audit_from,'audit_to':audit_to,'date_column':date_column,'lob':lob,'campaign':campaign,'vendor':vendor,'location':location,'agent_id':agent_id,'agents':agents,'data_list_type':data_list_type});
                 //console.log(reports_response);  
                $('#data_list').dataTable({
                    "bDestroy": true,
                    responsive: true,
