...
*	///////////////////////////
*/
if ( ! function_exists('email_template_account_activation'))
{
    function email_template_account_activation($client_first_name,$client_id , $token_key)
	{
		$message = 	'
			<html>
			<head>
            ...
            <thead>
                ...
                <tr>
                    <th style="padding:20px 30px 6px;text-align: center;text-transform: capitalize;font-size:20px;font-weight:800;color: #2E7D32;">Thank You, '.$client_first_name.'</th>
                </tr>
                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding:20px 30px 0;text-align: center;">
                                        <a href="https://facebook.com/KalbosSocial" target="_blank" style="border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;display:inline-block;vertical-align: middle;text-decoration:none;margin-right:3px;"><img src="'.base_url().'assets/images/facebook.png" alt="facebook" style="display:block;margin:0 auto;width:100%;height:auto;" /></a>
                                        <a href="https://twitter.com/Kalbos_Social" target="_blank" style="border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;display:inline-block;vertical-align: middle;text-decoration:none;margin-right:3px;"><img src="'.base_url().'assets/images/twitter.png" alt="twitter" style="display:block;margin:0 auto;width:100%;height:auto;" /></a>
                                        <a href="https://www.kalbos.io" target="_blank" style="border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;display:inline-block;vertical-align: middle;text-decoration:none;"><img src="'.base_url().'assets/images/kalbos.png" alt="kalbos" style="display:block;margin:0 auto;width:100%;height:auto;" /></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
